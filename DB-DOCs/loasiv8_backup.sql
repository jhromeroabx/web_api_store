...
INSERT INTO `tb_ingreso_producto` VALUES (1,1,3,40,0,1,1,0),(2,1,4,40,0,1,1,0),(3,2,3,40,0,1,1,0),(4,2,4,40,0,1,1,0),(5,3,3,40,0,1,1,0),(6,3,4,40,0,1,1,0),(7,4,3,40,13,1,1,1),(8,4,4,40,13,1,1,1);
...
INSERT INTO `tb_orden_compra` VALUES (1426,3,'Agua Cielo',20,'2022-05-31 00:21:27'),(1427,4,'Rellenitas',20,'2022-05-31 00:21:27'),(1428,6,'Chistris',20,'2022-05-31 00:21:27'),(1429,7,'Casino',20,'2022-05-31 00:21:27'),(1430,9,'Picaras clasicas',20,'2022-05-31 00:21:27'),(1431,10,'Ventilador portatil 123',20,'2022-05-31 00:21:27'),(1432,11,'NFT',20,'2022-05-31 00:21:27'),(1433,12,'Big Cola',20,'2022-05-31 00:21:27'),(1434,13,'test',20,'2022-05-31 00:21:27'),(1435,14,'test',20,'2022-05-31 00:21:27'),(1436,15,'test',20,'2022-05-31 00:21:27'),(1437,16,'test',20,'2022-05-31 00:21:27'),(1438,17,'Manzanas roja',20,'2022-05-31 00:21:27'),(1439,18,'frac',20,'2022-05-31 00:21:27'),(1440,19,'gretel',20,'2022-05-31 00:21:27'),(1441,20,'foquito',20,'2022-05-31 00:21:27'),(1442,21,'cifrut granadilla personal',20,'2022-05-31 00:21:27'),(1443,22,'alcohol',20,'2022-05-31 00:21:27'),(1444,23,'líquido paper standford',20,'2022-05-31 00:21:27'),(1445,24,'sporade',20,'2022-05-31 00:21:27'),(1446,25,'johan',20,'2022-05-31 00:21:27'),(1447,26,'DNI',20,'2022-05-31 00:21:27'),(1448,27,'desodorante Rexona men sport',20,'2022-05-31 00:21:27'),(1449,28,'banco de energía zmi aura',20,'2022-05-31 00:21:27'),(1450,29,'palillos chinos para restaurante',20,'2022-05-31 00:21:27');
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = utf8col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `fiutf8ctBy` */;
/*!50003 SET @saved_cs_client      = utf8cter_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `generarOrdenCompra`(IN `_exportable` BOOLEAN)
BEGIN
...
BEGIN
    ...
    SET @MSG := 'TODO BIEN, HAY DATOS DEL USER!!!';	
    	...
    	SET @ACCESS := IF( EXISTS(
            ...
            ON tp.id_user = tu.id 
utf8
            WHERE tu.email = _user ANutf8ntrasenia = _contrasenia), 1, 0);
utf8
    	IF @ACCESS = 1 THEN
...
BEGIN	
	...
	IF @existe_categoria = 1 THEN    utf8
utf8
utf8
...
-- Dump completed on 2022-05-31  0:29:23
